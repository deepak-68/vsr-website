        ...
        <div class="container z-index-common">
            ...
            <div class="breadcumb-menu-wrap">
                <ul class="breadcumb-menu">
                    ...
                    <li>{{ $cancelPolicy['sub_title'] ?? 'Terms & Conditions' }}</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="about-content">
                ...
                <div class="about-text">
                    @if($cancelPolicy && !empty($cancelPolicy['description']))
                        {{-- Render HTML content safely with allowed tags --}}
                        {!! strip_tags($cancelPolicy['description'], '<p><br><strong><em><ul><ol><li><h3><h4><a><span><div>') !!}
                    @else
