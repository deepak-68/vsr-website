        ...
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">
                    {{ $shippingPolicy['main_title'] ?? 'Terms & Conditions' }}
                </h1>
            </div>
            <div class="breadcumb-menu-wrap">
                <ul class="breadcumb-menu">
                    <li><a href="{{ route('home') }}">Home</a></li>
                    <li>{{ $shippingPolicy['sub_title'] ?? 'Terms & Conditions' }}</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="about-content">
                <div class="title-area wow fadeInUp wow-animated" data-wow-delay="0.3s">
                    <span class="sec-subtitle">
                        {{ $shippingPolicy['sub_title'] ?? 'Welcome to Farmix' }}
                    </span>
                    {{-- <h2 class="sec-title">
                        {{ $shippingPolicy['main_title'] ?? 'Terms & Conditions' }}
                    </h2> --}}
                ...
                <div class="about-text">
                    @if($shippingPolicy && !empty($shippingPolicy['description']))
                        {{-- Render HTML content safely with allowed tags --}}
                        {!! strip_tags($shippingPolicy['description'], '<p><br><strong><em><ul><ol><li><h3><h4><a><span><div>') !!}
                    @else
